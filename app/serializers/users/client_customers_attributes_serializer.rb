class Users::ClientCustomersAttributesSerializer < ActiveModel::Serializer
  ...
  has_many :customers_service_prices, key: 'customers_service_prices_attributes', serializer: Users::CustomerServicePricesAttributesSerializer
end
