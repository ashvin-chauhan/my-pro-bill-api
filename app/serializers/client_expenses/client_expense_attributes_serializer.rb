class ClientExpenses::ClientExpenseAttributesSerializer < ActiveModel::Serializer
  ...
  has_many :client_expense_attachments, key: "client_expense_attachments", serializer: ClientExpenses::AttchmentAttributesSerializer, :if => Proc.new { instance_options[:attachment] == true }
